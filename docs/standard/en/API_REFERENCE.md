...
`pyproject.toml` carries package version (`0.2.0` at time of writing). Public JSON/i18n catalogs are **not** semver-guarded separately — treat catalog key additions as contract changes for your fork.
