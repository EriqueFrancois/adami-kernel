...
class LifecycleManager:
    ...
    async def _send_reply_proxy(
        self, chat_id: Optional[Any], text: str, platform: str = "telegram"
    ) -> None:
    ...
    async def run_forever(self) -> None:
        ...
        # After nerves are up, notify chats with pending queues (Telegram/Discord).
        self.background_tasks.append(
    ...
    async def _notify_pending_task_queues_on_boot(self) -> None:
        ...
        proactively notify the user on chat platforms (Telegram/Discord).
        """
    ...
    async def _event_consumer(self) -> None:
        ...
        while self._running:
            ...
            asyncio.create_task(run_one(ev))
