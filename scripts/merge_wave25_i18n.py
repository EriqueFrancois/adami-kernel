#!/usr/bin/env python3
"""Merge wave25_i18n_strings.build_wave25_blobs into locales/*/common.json."""
...
from wave25_i18n_strings import build_wave25_blobs  # noqa: E402

REPO = Path(__file__).resolve().parents[1]


def main() -> None:
    en_blob, zh_blob = build_wave25_blobs()
