#!/usr/bin/env python3
"""Merge wave26_i18n_strings.build_wave26_blobs into locales/*/common.json."""
...
from wave26_i18n_strings import build_wave26_blobs  # noqa: E402

REPO = Path(__file__).resolve().parents[1]


def main() -> None:
    en_blob, zh_blob = build_wave26_blobs()
